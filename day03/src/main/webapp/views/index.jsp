...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="<c:url value="#" /> ">JS</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<c:url value="#"/> ">AJAX</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<c:url value="#"/> ">Map</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<c:url value="#"/> ">Chart</a>
      </li>
